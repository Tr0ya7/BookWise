...
const AuthForm = <T extends FieldValues>({ type, schema, defaultValues, onSubmit }: Props<T>) => {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <Form {...form}>
                <form className="space-y-6 w-full" onSubmit={form.handleSubmit(handleSubmit)}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        {field.name === "universityCard" ? <ImageUploader /> : <Input className="form-input" required type={FIELD_TYPES[field.name as keyof typeof FIELD_TYPES]} {...field} />}
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                ...
                <p className="text-center text-base font-medium">
                    {isSignIn ? "New to BookWise? " : "Alredy have an account? "}
