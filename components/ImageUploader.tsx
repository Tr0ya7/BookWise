...
const ImageUploader = ({ onFileChange }: { onFileChange: (filePath: string) => void }) => {
    ...
    const onError = (error: any) => {
        toast({ title: "Image upload failed", description: "Your image could not be uploaded. Please try again.", variant: "destructive" })
    }
    ...
    const onSuccess = (res: any) => {
        ...
        toast({ title: "Image uploaded sucessfully", description: `${res.filePath} uploaded sucessfully` })
    }
